    ...
    <footer className="pt-16 bg-darkmode">
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="grid grid-cols-1 sm:grid-cols-5 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
          ...
          <div className="">
            <h4 className="text-black dark:text-white mb-9 font-semibold text-xl">ติดต่อเรา</h4>
            <ul>
              <li className="pb-5">
                <p>มหาวิทยาลัยพะเยา</p>
              </li>
              <li className="pb-5">
                <p>คณะเทคโนโลยีสาระสนเทศและการสื่อสาร</p>
              </li>
              <li className="pb-5">
          ...
          <div className="">
            <h4 className="text-black dark:text-white mb-9 font-semibold text-xl">รายชื่อสมาชิก</h4>
            <ul>
              <li className="pb-5">
                <p>นาย ธนกฤต ชูเชิด</p>
              </li>
              <li className="pb-5">
                <p>นาย รัชภูมิ วงค์เรียน</p>
              </li>
              <li className="pb-5">
                <p>นาย อภิรักษ์ เขื่อนคำ</p>
              </li>
            </ul>
          </div>
          <div className="">
        ...
        <div className="border-t border-grey/15 dark:border-white/15 py-10 flex justify-between items-center">
          ...
          © 2025 Mobile Application Project. All rights reserved.
          </p>
